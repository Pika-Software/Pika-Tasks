...
- [ ] Онлайн перевод для мультиязычной системы для несосуществующих языков
...
- [90%] сделать систему хп, прочности и стабильности для строительства
...
- [ ] Сделать для молоточка возможность чинить пропы
