...
- [ ] Распаковать J I Defence для редактирования 
...
- [ ] Система "продвинутых инструментов" , а так же обнова от которой все потикут (нет)
  ...
  - [ ]  4. Упростить систему f2( это перемещение пропов если что) либо сделать его замену например строительный кран для постройки баз (возможно для этого понадобится полностью пустая мапа {пометка}[пустая мапа скушна нужен город])
