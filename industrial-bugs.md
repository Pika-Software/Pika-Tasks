...
- [ ] Нет соединений между постройками разных игроков, так же игроки не могут ставить чужие предметы.
- [ ] Баррон банни не работает
- [ ] Игрок может покупать вип предметы (не премиум)
